...
export const NEWS_SOURCE_REGISTRY: NewsSourceConfig[] = [
  // ========== 国内 AI 厂商官方公告 & 价格页 (P10) ==========
  {
    ...
    urls: ["https://platform.deepseek.com/api-docs/pricing", "https://api-docs.deepseek.com/news"],
    fetch_schedule: "0 */4 * * *", parser_type: "html", priority: 10,
  },
  {
    ...
    urls: ["https://help.aliyun.com/zh/model-studio/release-notes", "https://help.aliyun.com/zh/model-studio/model-pricing"],
    fetch_schedule: "0 */6 * * *", parser_type: "html", priority: 10,
  },
  {
  ...
  },
  {
    ...
    urls: ["https://cloud.tencent.com/document/product/1729/101854"],
    fetch_schedule: "0 */6 * * *", parser_type: "html", priority: 10,
  },
  {
  ...
  },
  {
    ...
    urls: ["https://siliconflow.cn/pricing", "https://docs.siliconflow.cn"],
    fetch_schedule: "0 */6 * * *", parser_type: "html", priority: 10,
  },
